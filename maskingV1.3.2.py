...
class MaskingV12Analyzer:
    ...
    def fit(
        ...
        if reuse_model:
            print("[-] Warm start: continuing from existing V1.3.2 model state.")
...
def main():
    parser = argparse.ArgumentParser(description="maskingV1.3.2: V1.3 decomposition PINN with CPU-friendly warm-start/shuffle controls")
    ...
    parser.add_argument("--shuffle-every-epochs", type=int, default=1)
